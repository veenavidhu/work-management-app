...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>" class="logo">
      ...
      <span class="logo-lg"><b>Staff</b> Management</span>
    </a>
...
<!--        <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>apply-Daily-Task"><i class="fa fa-circle-o"></i> Apply Daily Task</a></li>
            <li><a href="<?php echo base_url(); ?>view-DailyTask"><i class="fa fa-circle-o"></i> My Task History</a></li>
            <li><a href="<?php echo base_url(); ?>apply-Leave"><i class="fa fa-circle-o"></i> Apply Leave</a></li>
            <li><a href="<?php echo base_url(); ?>view-leave"><i class="fa fa-circle-o"></i> My Task History</a></li>
