...
<!--        <li class="treeview">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Work</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>approve-DailyTask"><i class="fa fa-circle-o"></i> Manage Staff's Work</a></li>
            <li><a href="<?php echo base_url(); ?>dailyTask-history"><i class="fa fa-circle-o"></i> Work History</a></li>
